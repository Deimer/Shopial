...
//        view = new RelativeLayout(this);
        ...
        authURLString = AUTHURL + "?client_id=" + client_id + "&redirect_uri=" + CALLBACKURL + "&response_type=code&display=touch&scope=basic+likes+relationships+public_content+follower_list+comments";
